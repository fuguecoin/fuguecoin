...
const QString BITCOIN_IPC_PREFIX("fuguecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click fuguecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start fuguecoin: click-to-pay handler");
    else
...
{
    // clicking on fuguecoin: URLs creates FileOpen events on the Mac:
